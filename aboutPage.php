...
<div class="about-container">
    <section class ="portfolio-section">
        <div class="portfolio-img-box">
            <img src="http://portfolio3.local/wp-content/uploads/2022/06/about-image.png" alt="">
        </div>
    </section>
    ...
    <section class ="featured-skill-section">
        <div class="featured-skill-box">
            
            <div class="designer-box">
           
                <img src="http://portfolio3.local/wp-content/uploads/2022/06/figma.jpg" alt="">
            </div>
            <div class="designer-intro-box">
                ...
                <a href="http://portfolio3.local/contact/"  target = "_blank" class="btn btn-primary">Hire Me</a>
                <a href="http://portfolio3.local/wp-content/uploads/2022/07/Suman-Mainali-Resume.docx"  target = "_blank" class="btn btn-primary">Download my CV</a>
            </div>
           
            <div class="developer-intro-box">
                <h1>I am a Web Developer</h1>
                <pre>
                <h3>I Use WordPress CMS to:</h3> 
                * Start Blugging 
                * Make a business websites
            ...
            <div class="developer-box">
                ...
                <img src="http://portfolio3.local/wp-content/uploads/2022/06/wordpress-bg.jpg" alt="">
            </div>
